...
define( 'AI1ECSW_VERSION', '1.1.4' );
define( 'AI1ECSW_URL',                 plugins_url( '', __FILE__ ) );
define( 'AI1ECSW_FILE',                __FILE__ );
define( 'AI1ECSW_ADMIN_THEME_CSS_URL', AI1ECSW_URL . '/public/admin/css/' );

/*
if ( isset( $_GET['ai1ec_super_widget'] ) && ! isset( $_GET['ai1ec_sw_version'] ) ) {
	header(
		'Location: ?ai1ec_super_widget=true&ai1ec_sw_version=' . AI1ECSW_VERSION,
		true,
		307
	);
	exit( 0 );

...
class BWGViewWidget {
  ...
  function widget($args, $instance) {
    ...
    $view_type = (isset($instance['view_type']) ? $instance['view_type'] : "gallery");
  ...
  function form($instance, $id_title, $name_title, $id_type, $name_type, $id_show, $name_show, $id_gallery_id, $name_gallery_id, $id_album_id, $name_album_id, $id_count, $name_count, $id_width, $name_width, $id_height, $name_height, $id_theme_id, $name_theme_id, $id_view_type, $name_view_type) {
    ...
    <p>
      ...
      <input type="radio" name="<?php echo $name_type; ?>" id="<?php echo $id_type . "_2"; ?>" value="album" class="sel_album" onclick="bwg_change_type(event, this)" <?php if ($instance['type'] == "album") echo 'checked="checked"'; ?> /><label for="<?php echo $id_type . "_2"; ?>">Album</label>
				<span id="view_type_container" style="display: <?php echo $instance['type'] != 'album' ? 'block' : 'none'; ?>; margin-bottom: 5px;">
				<input style="width:9px; height:9px;" type="radio" name="<?php echo $name_view_type; ?>" id="<?php echo $id_view_type . "_1"; ?>" value="thumbnails" class="sel_thumbnail_gallery"  <?php if (isset($instance['view_type']) && $instance['view_type'] == "thumbnails") echo 'checked="checked"';  ?> />
				<label for="<?php echo $id_view_type . "_1"; ?>">Thumbnail</label>
				<input style="width:9px; height:9px;" type="radio" name="<?php echo $name_view_type; ?>" id="<?php echo $id_view_type . "_2"; ?>" value="masonry" class="sel_masonry_gallery"  <?php if (isset($instance['view_type']) && $instance['view_type'] == "masonry") echo 'checked="checked"'; ?> />
				<label for="<?php echo $id_view_type . "_2"; ?>">Masonry</label>
			</span>

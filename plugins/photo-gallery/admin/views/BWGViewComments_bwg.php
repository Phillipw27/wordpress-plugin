...
class BWGViewComments_bwg {
  ...
  public function display() {
    ...
    <div style="font-size: 14px; font-weight: bold;">
      ...
      <a style="color: blue; text-decoration: none;" target="_blank" href="http://web-dorado.com/wordpress-gallery-guide-step-8.html">Read More in User Manual</a>
    </div>
    <form class="wrap" id="comments_form" method="post" action="admin.php?page=comments_bwg" style="width:99%;">
      ...
      <div class="tablenav top">
        ...
        WDWLibrary::html_page_nav($page_nav['total'], $page_nav['limit'], 'comments_form', $per_page);
        ?>
      </div>
            ...
            foreach ($rows_data as $row_data) {
              ...
              <tr id="tr_<?php echo $row_data->id; ?>" <?php echo $alternate; ?>>
                ...
                <td class="table_big_col ">
                  ...
                  ?>
                  <img title="<?php echo $row_data->alt; ?>" style="border: 1px solid #CCCCCC; max-width:60px; max-height:60px;" src="<?php echo site_url() . '/' . $WD_BWG_UPLOAD_DIR . $row_data->thumb_url . '?date=' . date('Y-m-y H:i:s'); ?>">
                  <?php
                  }
                  ?>
                </td>

...
class  BWGViewThemes_bwg {
  ...
  public function display() {
    ...
    <form class="wrap" id="themes_form" method="post" action="admin.php?page=themes_bwg" style="width:99%;">
  ...
  public function edit($id, $reset) {
    ...
    <form class="wrap" method="post" action="admin.php?page=themes_bwg" style="width:99%;">
      ...
      <div style="float: left; margin: 10px 0 0; display: none;" id="type_menu">
        ...
        <div id="type_Mosaic" class="theme_type" onclick="bwg_change_theme_type('Mosaic')">Mosaic</div>
        ...
        <div id="type_Masonry_album" class="theme_type" onclick="bwg_change_theme_type('Masonry_album')">Masonry Album</div>
        ...
        <fieldset class="spider_type_fieldset" id="Mosaic">
          <fieldset class="spider_child_fieldset" id="Mosaic_1">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_padding">Padding: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_border_width">Border width: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_border_style">Border style: </label></td>
                  <td>
                    <select name="mosaic_thumb_border_style" id="mosaic_thumb_border_style">
                      <?php
                      foreach ($border_styles as $key => $border_style) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->mosaic_thumb_border_style == $key) ? 'selected="selected"' : ''); ?>><?php echo $border_style; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_border_color">Border color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_border_radius">Border radius: </label></td>
                  <td>
          ...
          <fieldset class="spider_child_fieldset" id="Mosaic_2">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_transparent">Transparency: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumbs_bg_color">Background color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_bg_transparent">Background transparency: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_align0">Alignment: </label></td>
                  <td>
                    <select name="mosaic_thumb_align" id="mosaic_thumb_align">
                      <?php
                      foreach ($aligns as $key => $align) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->mosaic_thumb_align == $key) ? 'selected="selected"' : ''); ?>><?php echo $align; ?></option>
                        <?php
                      }
                      ?>
                    </select>
          ...
          <fieldset class="spider_child_fieldset" id="Mosaic_3">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_hover_effect">Hover effect: </label></td>
                  <td>
                    <select name="mosaic_thumb_hover_effect" id="mosaic_thumb_hover_effect" class="spider_int_input">
                      <?php
                      foreach ($hover_effects as $key => $hover_effect) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->mosaic_thumb_hover_effect == $key) ? 'selected="selected"' : ''); ?>><?php echo $hover_effect; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_hover_effect_value">Hover effect value: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_title_font_size">Title font size: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_title_font_color">Title font color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_title_font_style">Title font family: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_title_font_weight">Title font weight: </label></td>
                  <td>
                    <select name="mosaic_thumb_title_font_weight" id="mosaic_thumb_title_font_weight">
                      <?php
                      foreach ($font_weights as $key => $font_weight) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->mosaic_thumb_title_font_weight == $key) ? 'selected="selected"' : ''); ?>><?php echo $font_weight; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_title_shadow">Title box shadow: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="mosaic_thumb_title_margin">Title margin: </label></td>
                  <td>
        ...
        <fieldset class="spider_type_fieldset" id="Extended_album">
          ...
          <fieldset class="spider_child_fieldset" id="Masonry_album_1">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_border_width">Border width: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_border_style">Border style: </label></td>
                  <td>
                    <select name="album_masonry_thumb_border_style" id="album_masonry_thumb_border_style">
                      <?php
                      foreach ($border_styles as $key => $border_style) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->album_masonry_thumb_border_style == $key) ? 'selected="selected"' : ''); ?>><?php echo $border_style; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_border_color">Border color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_border_radius">Border radius: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_hover_effect">Hover effect: </label></td>
                  <td>
                    <select name="album_masonry_thumb_hover_effect" id="album_masonry_thumb_hover_effect">
                      <?php
                      foreach ($hover_effects as $key => $hover_effect) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->album_masonry_thumb_hover_effect == $key) ? 'selected="selected"' : ''); ?>><?php echo $hover_effect; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_hover_effect_value">Hover effect value: </label></td>
                  <td>
                ...
                <tr>
                  ...
                  <td id="album_masonry_thumb_transition">
                    ...
                    <label for="album_masonry_thumb_transition1" id="album_masonry_thumb_transition1_lbl">Yes</label>
                    ...
                    <label for="album_masonry_thumb_transition0" id="album_masonry_thumb_transition0_lbl">No</label>
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <fieldset class="spider_child_fieldset" id="masonry_album_2">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumbs_bg_color">Full background color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_bg_transparent">Full background transparency: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_thumb_align0">Alignment: </label></td>
                  <td>
                    <select name="album_masonry_thumb_align" id="album_masonry_thumb_align">
                      <?php
                      foreach ($aligns as $key => $align) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->album_masonry_thumb_align == $key) ? 'selected="selected"' : ''); ?>><?php echo $align; ?></option>
                        <?php
                      }
                      ?>
                    </select>
          ...
          <fieldset class="spider_child_fieldset" id="masonry_album_3">
            <table style="clear:both;">
              <tbody>
                <tr>
                  <td class="spider_label"><label for="album_masonry_title_font_size">Title font size: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_title_font_color">Title font color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_title_font_style">Title font family: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_title_font_weight">Title font weight: </label></td>
                  <td>
                    <select name="album_masonry_title_font_weight" id="album_masonry_title_font_weight">
                      <?php
                      foreach ($font_weights as $key => $font_weight) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->album_masonry_title_font_weight == $key) ? 'selected="selected"' : ''); ?>><?php echo $font_weight; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_title_shadow">Title box shadow: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_back_font_size">Font size: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_back_font_color">Font color: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_back_font_style">Font family: </label></td>
                  <td>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_back_font_weight">Font weight: </label></td>
                  <td>
                    <select name="album_masonry_back_font_weight" id="album_masonry_back_font_weight">
                      <?php
                      foreach ($font_weights as $key => $font_weight) {
                        ?>
                        <option value="<?php echo $key; ?>" <?php echo (($row->album_masonry_back_font_weight == $key) ? 'selected="selected"' : ''); ?>><?php echo $font_weight; ?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <tr>
                  <td class="spider_label"><label for="album_masonry_back_padding">Back padding: </label></td>
                  <td>

...
class BWGViewOptions_bwg {
  ...
  public function display($reset = FALSE) {
    ...
    ?>
    <form method="post" class="wrap" action="admin.php?page=options_bwg" style="width:99%;">      
                ...
                <table style="display: inline-table;">
                  <tbody>			
                    ...
                    <tr id="tr_popup_hit_counter">
                      ...
                      <td>
                        <input type="radio" name="popup_hit_counter" id="popup_hit_counter_1" value="1" <?php if ($row->popup_hit_counter) echo 'checked="checked"'; ?> /><label for="popup_hit_counter_1">Yes</label>
                        <input type="radio" name="popup_hit_counter" id="popup_hit_counter_0" value="0" <?php if (!$row->popup_hit_counter) echo 'checked="checked"'; ?> /><label for="popup_hit_counter_0">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    <tr>
                ...
                <table style="display: inline-table;">
                  <tbody>
                    <tr id="tr_popup_rate">
                      ...
                      <td>
                        <input type="radio" name="popup_enable_rate" id="popup_enable_rate_1" value="1" <?php if ($row->popup_enable_rate) echo 'checked="checked"'; ?> /><label for="popup_enable_rate_1">Yes</label>
                        <input type="radio" name="popup_enable_rate" id="popup_enable_rate_0" value="0" <?php if (!$row->popup_enable_rate) echo 'checked="checked"'; ?> /><label for="popup_enable_rate_0">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    ...
                    <tr id="tr_comment_moderation">
                      ...
                      <td>
                        <input type="radio" name="comment_moderation" id="comment_moderation_1" value="1" <?php if ($row->comment_moderation) echo 'checked="checked"'; ?> /><label for="comment_moderation_1">Yes</label>
                        <input type="radio" name="comment_moderation" id="comment_moderation_0" value="0" <?php if (!$row->comment_moderation) echo 'checked="checked"'; ?> /><label for="comment_moderation_0">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    ...
                    <tr id="tr_popup_pinterest">
                      ...
                      <td>
                        <input type="radio" name="popup_enable_pinterest" id="popup_enable_pinterest_1" value="1" <?php if ($row->popup_enable_pinterest) echo 'checked="checked"'; ?> /><label for="popup_enable_pinterest_1">Yes</label>
                        <input type="radio" name="popup_enable_pinterest" id="popup_enable_pinterest_0" value="0" <?php if (!$row->popup_enable_pinterest) echo 'checked="checked"'; ?> /><label for="popup_enable_pinterest_0">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
                    <tr id="tr_popup_tumblr">
                      ...
                      <td>
                        <input type="radio" name="popup_enable_tumblr" id="popup_enable_tumblr_1" value="1" <?php if ($row->popup_enable_tumblr) echo 'checked="checked"'; ?> /><label for="popup_enable_tumblr_1">Yes</label>
                        <input type="radio" name="popup_enable_tumblr" id="popup_enable_tumblr_0" value="0" <?php if (!$row->popup_enable_tumblr) echo 'checked="checked"'; ?> /><label for="popup_enable_tumblr_0">No</label>
                        <div class="spider_description"></div>
                      </td>
                    </tr>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <input type="radio" name="album_view_type" id="album_view_type_2" value="mosaic" <?php if ($row->album_view_type == "mosaic") echo 'checked="checked"'; ?> /><label for="album_view_type_1">Mosaic</label>
                ...
                <table style="display: inline-table;">
                  <tbody>
                    ...
                    <tr id="tr_slideshow_filmstrip_height">
                      <td class="spider_label_options"><label for="slideshow_filmstrip_height">Slideshow filmstrip size: </label></td>
                      <td>
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="radio" name="show_masonry_thumb_description" id="masonry_thumb_desc_1" value="1" <?php if ($row->show_masonry_thumb_description) echo 'checked="checked"'; ?> /><label for="masonry_thumb_desc_1">Yes</label>
                  <input type="radio" name="show_masonry_thumb_description" id="masonry_thumb_desc_0" value="0" <?php if (!$row->show_masonry_thumb_description) echo 'checked="checked"'; ?> /><label for="masonry_thumb_desc_0">No</label>
                  <div class="spider_description"></div>
                </td>
              </tr>
              <tr>

...
function bwg_options_panel() {
  ...
  $rates_page = add_submenu_page('galleries_bwg', 'Ratings', 'Ratings', 'manage_options', 'rates_bwg', 'bw_gallery');
...
function bw_gallery() {
  ...
  if (($page != '') && (($page == 'galleries_bwg') || ($page == 'albums_bwg') || ($page == 'tags_bwg') || ($page == 'options_bwg') || ($page == 'comments_bwg') || ($page == 'rates_bwg') || ($page == 'themes_bwg') || ($page == 'licensing_bwg') || ($page == 'uninstall_bwg') || ($page == 'BWGShortcode'))) {
...
function bwg_front_end_scripts() {
  ...
  wp_enqueue_script('bwg_raty', WD_BWG_URL . '/js/jquery.raty.js', array(), '2.5.2');

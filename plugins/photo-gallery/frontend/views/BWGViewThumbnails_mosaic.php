      ...
      <div id="bwg_container2_<?php echo $bwg; ?>">
        <form id="gal_front_form_<?php echo $bwg; ?>" method="post" action="#">	
          ...
          <div id="bwg_mosaic_thumbnails_div_<?php echo $bwg; ?>" style="position:relative; background-color: rgba(<?php echo $rgb_thumbs_bg_color['red']; ?>, <?php echo $rgb_thumbs_bg_color['green']; ?>, <?php echo $rgb_thumbs_bg_color['blue']; ?>, <?php echo number_format($theme_row->mosaic_thumb_bg_transparent / 100, 2, ".", ""); ?>); text-align: <?php echo $theme_row->mosaic_thumb_align; ?>; width: 100%;">
            <div id="ajax_loading_<?php echo $bwg; ?>" style="position:absolute; top:0px;  width: 100%; z-index: 115; text-align: center; height: 100%; vertical-align: middle; display: none;">
            ...
            <?php
						if (!$from) {
							if ($params['image_enable_page']  && $params['images_per_page'] && ($theme_row->page_nav_position == 'top')) {
								WDWLibrary::ajax_html_frontend_page_nav($theme_row, $page_nav['total'], $page_nav['limit'], 'gal_front_form_' . $bwg, $params['images_per_page'], $bwg, 'bwg_mosaic_thumbnails_' . $bwg);
							}
						}
            ?>
            <div id="bwg_mosaic_thumbnails_<?php echo $bwg; ?>" class="bwg_mosaic_thumbnails_<?php echo $bwg; ?>">
              ...
              foreach ($image_rows as $image_row) {
                $params_array = array(
                  ...
                  'resizable_mosaic' => $params['resizable_mosaic'],
                  'mosaic_total_width' => $params['mosaic_total_width'],
                ...
                <div class="bwg_mosaic_thumb_spun_<?php echo $bwg; ?>">
                  ...
                  <?php
                        ...
                        ?>
                          <img class="bwg_mosaic_thumb_<?php echo $bwg; ?>" id="<?php echo $image_row->id; ?>" src="<?php echo ($is_video ? "" : site_url() . '/' . $WD_BWG_UPLOAD_DIR) . $image_row->thumb_url; ?>" alt="<?php echo $image_row->alt; ?>" 
            ...
            <script>
             ...
             /*DO NOT USE SINGLE LINE COMMENT IN JAVASCRIPT!!!*/
    ...
    <script>
      ...
      if (bwg_hash) {
        if (bwg_hash.indexOf("bwg") != "-1") {
          ...
          spider_createpopup('<?php echo addslashes(add_query_arg($params_array_hash, admin_url('admin-ajax.php'))); ?>&image_id=' + bwg_hash_array[1], '<?php echo $bwg; ?>', '<?php echo $params['popup_width']; ?>', '<?php echo $params['popup_height']; ?>', 1, 'testpopup', 5);
        }
      }
      <?php
      }

                ...
                if ($type == 'text') {
                  ...
                  <li style="text-align: center;">
                    <a href="<?php echo $tag->permalink; ?>">
                      <img id="img" src="<?php echo ($is_video ? "" : site_url() . '/' . $WD_BWG_UPLOAD_DIR) . $tag->thumb_url;?>" alt="<?php echo $tag->name; ?>" title="<?php echo $show_name ? '' : $tag->name; ?>" /><?php echo $show_name ? '<br />' . $tag->name : ''; ?>
                  </a></li>
                  <?php
                }
              }

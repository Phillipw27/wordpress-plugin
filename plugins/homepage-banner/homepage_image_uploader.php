...
<div class="homebanner">';
	foreach($bug_items as $items){
		...
		$output .= '<div class="home_header_1">'. $items['banner_header_1'].'</div><a href="/wamemphis'.$items['button_link'].'"><button class="home_header_2">'.$items['banner_header_2'].'</button></a></div>';

		...
		<div class='menu_settings'>
            ...
            <form action="<?php echo admin_url('admin-post.php'); ?>" method="post">
				...
				if ( $activated_domain && $activated_domain != $current_domain ) {
					...
					echo "<p>If you have a single site licence (or have otherwise hit your licence activation limit) you will need to ensure the licence is deactivated against the old domain before reactivating the licence on this domain. To do this, log into the old domain and deactivate the licence. Alternatively you can increase your site activation limit by upgrading your licence in your <a href='https://www.maxmegamenu.com'>Client Area</a>.</p>";
					echo "<p>You can also manage your active domains within your <a href='https://www.maxmegamenu.com'>Client Area</a> (your username is your email address, if you have not set a password use the Lost Password option).</p>";
